ActiveAdmin.register User do
  ...
  permit_params :salutation, :name, :gender, :username, :email, :password, :password_confirmation, :mobile, :date_of_birth, :type, :premier, :call_verified, :blacklisted, :active, :created_by, :updated_by
