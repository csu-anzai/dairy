...
json.users do
	json.array! @users do |usr|
	  ...
	  json.date_of_birth usr.date_of_birth.strftime('%d-%b-%Y')
	  ...
	  json.created_at usr.created_at.strftime('%d-%b-%Y ⌚ %I:%M %p')
	  json.updated_at usr.updated_at.strftime('%d-%b-%Y ⌚ %I:%M %p')
	end
end
